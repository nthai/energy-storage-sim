...
def main():
    # test_sim(ConstLimPeakShaveSim, 'Const', margin=.2, penalize_charging=True, create_log=True, verbose=True)
    # test_sim(DynamicLimPeakShaveSim, 'Dynamic', lookahead=24, margin=.1134, penalize_charging=True, create_log=True)
